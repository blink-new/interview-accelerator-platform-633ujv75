...
const BookingPage = () => {
  ...
  useEffect(() => {
    ...
    // Check if user came back from Calendly
    const fromCalendly = searchParams.get('calendly')
    if (fromCalendly === 'completed') {
  ...
  const handleCompleteBooking = () => {
    ...
    if (serviceType && !completedServices.includes(serviceType)) {
      completedServices.push(serviceType)
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-green-700">
                      Did you successfully book your session with the mentor? Click below to mark this service as completed.
                    </p>
                  </div>
                  <Button 
